...
def index(request):
    ...
    context_dict = {'boldmessage':'TIME TO GO HOME','categories':category_list,'pages':page_list}
    #print(reverse('rango:index')) #prints '/rango/index'
    return render(request, 'rango/index.html', context=context_dict)
    

def about(request):
    context_dict = {'boldmessage':'ABOUT MY FRUITS', 'MEDIA_URL':'/media/'}
